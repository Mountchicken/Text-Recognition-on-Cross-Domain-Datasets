...
parser.add_argument('--alphabets',type=str,choices=['casia_360cc','lowercase','allcases','allcases_symbols'])
...
parser.add_argument('--decode_type', type=str,choices=['Attention','CTC', 'DAN'])
